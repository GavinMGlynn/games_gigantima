...
-------------------
  ...
  LICENSE: OGA-BY 3.0
  DETAILS: 
	Row 1 & 2: Original CC0 by BlueCarrot16. Recolored by Eliza Wyatt.
	Row 3+: Original by Eliza Wyatt.
...
## Objects/Small Items/Ores & Ingots
...
-------------------
  ARTIST(S): BlueCarrot16
  SOURCE: https://opengameart.org/content/lpc-ore-and-forge
  LICENSE: OGA-BY 3.0
  DETAILS: Original by BlueCarrot. Recolored by Eliza Wyatt.
```
...
-------------------
  ...
  SOURCE: https://opengameart.org/content/liberated-pixel-cup-lpc-base-assets-sprites-map-tiles
  LICENSE: OGA-BY 3.0
  DETAILS: Original by Lanea Zimmerman. Reworked for tiling by Eliza Wyatt. Recolors by Eliza Wyatt.

Rope Bridge A (rails, no rails)
-------------------
  ARTIST(S): Lanea Zimmerman (Sharm), Eliza Wyatt (DeathsDarling)
  SOURCE: https://opengameart.org/content/liberated-pixel-cup-lpc-base-assets-sprites-map-tiles
  LICENSE: OGA-BY 3.0
