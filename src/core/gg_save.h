...
// version is a new save version whether or not the game's own half moved - and
// 15 is that happening once more, for the map's region byte meaning something.
